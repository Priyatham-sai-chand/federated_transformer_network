...
examples = tfds.load(name='wmt14_translate/de-en',
          ...
          download=False)
examples = examples[0]
train_examples = examples['validation']
...
sentence = "Dies führt dazu, dass ein Spieler wie ich, die Stirn bieten muss und sein Bestes geben will."
ground_truth = "Which is what makes a player like me want to face up and give my best."
...
class ExportTranslator(tf.Module):
  ...
  def __call__(self, sentence):
    (result, 
     tokens,
     attention_weights) = self.translator(sentence, max_length=1000)
    
    return result

#prediction_name = translator("ich heiße priyatham").numpy()
#print("input: ich heiße priyatham")
#print("prediction: "+prediction_name)
#print("ground truth: my name is priyatham")

translator = ExportTranslator(translator)
tf.saved_model.save(translator, export_dir='translator_model')
